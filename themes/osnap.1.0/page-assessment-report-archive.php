<?php
/*
Template Name: Assessment Report Archive
*/
?>
...
#logo-container img { top: 0; }
#outerwrapper { background-image: none; }
...
.table.table-striped {border-top: 1px solid gray;}
			...
			if ($has_practice_lead) {
				...
				<div class="report-top">
					<div class="report-top-left">
						<h3><?php echo $fields['practice_title'] ?> <?php echo $user_login; ?> </h3>
