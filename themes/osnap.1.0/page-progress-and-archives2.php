<?php
/*
Template Name: Progress Overview and Archives NEW
*/
?>
		...
		<div id="archives-box">
			<div class="mytools-row">
				<div class="rightbox">
					...
					<div id="reset-all-dialog" title="RESET ALL">

						<div class="confirm-text"><b>CAUTION:</b> This will delete your answers in the Daily Practice and Policy Self-Assessments, as well as your current Assessment Report and Action Plans.  Only those versions that you have archived as PDFs above will remain.
						</div>
					...
					$( "body" ).on( "click", "#reset-all", function() {
						...
						// show delete button, change the text of cancel button, and set result div html
						$('#reset-all.btn').show();
						$('.reset-all-cancel.btn').text('Cancel'); 
						$( "#reset-all-dialog .confirm-text" ).show();
						$( "#reset-all-dialog .loader" ).hide();
						$( "#reset-all-dialog .result" ).html('');
					...
					$( "#reset-all-dialog" ).dialog({ 
						...
						buttons: { 
							'Delete': {
								'class': 'reset-all-confirm btn',
								text: 'RESET',
								click: function() {
							
									$( "#reset-all-dialog .confirm-text" ).hide();	
									$( "#reset-all-dialog .loader" ).show();	

									// reset all forms for this user
									var resetUrl = "http://osnap.org/reset-all/";
									$( "#reset-all-dialog" ).load( resetUrl, function() {
										$(this).parent().parent().find('button:contains("RESET")').hide(); 
										$(this).parent().parent().find('button:contains("Cancel")').text('OK');
										$( "#reset-all-dialog .confirm-text" ).hide();	
							...
							'Cancel': {
								...
								click: function() {
								// reset buttons, messages and close dialog
									$(this).parent().parent().find('button:contains("RESET")').show();
									$(this).parent().parent().find('button:contains("OK")').text('Cancel');
									$(this).dialog('close');
								}
							}
		...
		<div id="archives-box">
			<div class="mytools-row">
				<div class="rightbox">
					...
					<p>You currently have the following number of saved forms that will be deleted upon reset:</p>
					<br/>
					<?php echo findAllMyEntries(); ?>
					<br/>
