<?php
/*
Template Name: The Report - Vertical
*/
?>
...
<div id="content" class="row">
	...
	<div id="tool-container">
		...
		<?php if ( is_user_logged_in() ) { ?>	
			...
			<?php if ($has_practice_lead) { ?>			
				...
				<thead>
					<tr>
						...
						<td><?php echo $fields['table_head_c2'] ?></td>
					<tr>
				</thead>
				<tbody>
					<tr>
			...
			<div class="report-top">
				<div class="report-top-left">
					<h3><?php echo $fields['policy_title'] ?></h3>
					<?php echo $fields['policy_text'] ?>
				</div>
			</div>
			<?php
			...
			if ($has_policy_lead) {
				...
				$has_computer = $my_policy_lead['68'];
				$has_tv = $my_policy_lead['76'];
				...
				<tbody>
					...
					<?php } else { ?>
						<tr>
							<td class="standard"><?php echo $fields['snacks_skipped_txt'] ?></td>
							<td></td>
						</tr>
					<?php } ?>
			...
			<?php	
				...
				<div class="assessment-not-done">
					<h4>The policy self-assessment has not yet been completed.</h4>
					<p>Use the menu on the left to explore the introduction and 'Getting Started', 
					or jump to <a href="<?php echo $site_url ?>/tools/policy-assessment/policy-assessment-tool/">
					the policy self-assessment</a>.</p>
				</div>
			<?php } ?>		
			<!-- end POLICY report -->
